...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Moonlight Stars";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "You can only exchange your token for another's"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerAddress == msg.sender, "You can only tranfer a star you own");
